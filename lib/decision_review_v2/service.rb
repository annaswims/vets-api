...
require 'decision_review_v2/configuration'
require 'decision_review_v2/service_exception'

module DecisionReviewV2
  ##
  ...
  class Service < Common::Client::Base
    ...
    configuration DecisionReviewV2::Configuration
