...
class MPIData < Common::RedisStore
  ...
  def add_person_proxy
    ...
    if search_response.ok?
      ...
      add_response = mpi_service.add_person_proxy(last_name: user_identity.last_name,
