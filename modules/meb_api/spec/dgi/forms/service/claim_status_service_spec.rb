...
require 'dgi/forms/service/claim_status_service'

RSpec.describe MebApi::DGI::Forms::Status::Service do
  VCR.configure do |config|
    ...
    let(:service) { MebApi::DGI::Forms::Status::Service.new(user) }
    ...
    describe '#get_fry_claim_status' do
      ...
      context 'when successful' do
        it 'returns a status of 200' do
          VCR.use_cassette('dgi/forms/get_fry_claim_status') do
    ...
    describe '#get_toe_claim_status' do
      ...
      context 'when successful' do
        it 'returns a status of 200' do
          VCR.use_cassette('dgi/forms/get_toe_claim_status') do
