...
RSpec.describe MebApi::DGI::Forms::Letter::Service do
  VCR.configure do |config|
    ...
    let(:service) { MebApi::DGI::Forms::Letter::Service.new(user) }
    ...
    describe '#get_fry_letter' do
      ...
      context 'when successful' do
        it 'returns a status of 200' do
          VCR.use_cassette('dgi/forms/get_fry_letter') do
    ...
    describe '#get_toe_letter' do
      ...
      context 'when successful' do
        it 'returns a status of 200' do
          VCR.use_cassette('dgi/forms/get_toe_letter') do
            response = service.get_claim_letter(claimant_id, 'toe')
            expect(response.status).to eq(200)
          end
        end
      end
